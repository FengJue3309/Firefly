...
export const siteConfig: SiteConfig = {
	...
	// 站点描述
	description:
		"枫诀网络科技工作室官方网站主要分享编程开发。网络技术及创意设计相关资源与资讯，提供最新的技术文章、开源项目案例及行业动。态关注我们，探索互联网技术的无限可能。",
	...
	analytics: {
		...
		umamiAnalytics: {
			// Umami Website ID
			websiteId: "29ee9213-3802-49ae-ba3c-bea365257998",
			// Umami JS地址，支持使用自建
			scriptUrl: "https://umami.v7w.cn/script.js",
		},
		// 51la 统计配置
		la51Analytics: {
			// 51la 统计 ID
